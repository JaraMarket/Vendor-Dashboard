...
Future<http.Response> _retryRequest(
  ...
  Future<bool> onboarding_signup(String firstName, String lastName,String email,String phoneNumber, String password) async {
  ...
  final Map<String, String> header = {
    ...
    'Accept': 'application/json',
      ...
      var response = await http.post(
        headers: header,
      Uri.parse('https://admin.jaramarket.com.ng/api/jaram/register?cache-buster=${fn_generateCacheBuster()}'), body: jsonEncode({
    'firstname': firstName,
    'lastname': lastName,
    'email': email,
...
//     final token = prefs.setString('token') ?? '';
       ...
       arguments: {
        ...
        // }
          ...
          SnackbarUtils.showSnackbarError(
          "Oops", "${jsonDecode(response.body)['message']}\n ${jsonDecode(response.body)}");
      }
...
OverlayLoadingProgress.stop();
     ...
     OverlayLoadingProgress.stop();
      ...
      SnackbarUtils.showSnackbarError(
          "Oops", "Sign up failed! ${error.toString()}");
...
Future<http.Response> getCheckoutAddress() async {
  ...
  Future<http.Response> validateUserSignupEmail(
      Map<String, dynamic> otpData) async {
    final url = Uri.parse('https://admin.jaramarket.com.ng/api/jaram/validate-email');
    _logRequest('POST', url, body: otpData);
    final response = await http.post(
      url,
      headers: <String, String>{
