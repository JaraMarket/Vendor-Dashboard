...
Future<void> updateVendorProfileBusinessAddress() async {
  ...
  var email = await dataBase.getEmail();
    try {      
      ...
      request.fields['business_address'] = addressController.text.isNotEmpty ? addressController.text : 'mobile and online services only';
      ...
      //   );
        Get.snackbar("Success", "Business Address updated successfully",colorText: Colors.white, backgroundColor: Colors.green);
