          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 24),
                ElevatedButton(
                  onPressed:  () => (_isButtonEnabled && !_isLoading) ? controller.processSignUp() : null,// () { ()
                    // Navigator.pushNamed(context, '/email-verification');
                  //  controller.processSignUp();
                  //},
                  style: ElevatedButton.styleFrom(backgroundColor: _isButtonEnabled ? Theme.of(context).primaryColor : Colors.grey),
