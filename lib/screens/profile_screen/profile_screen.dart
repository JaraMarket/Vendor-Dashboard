...
import 'package:jara_market/widgets/avatar_with_edtt.dart';
  ...
  void _showEditContactInfoDialog() {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        title: const Text('Edit Contact Information',style: TextStyle(fontSize: 18),),
        content: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            TextField(
              ...
              decoration: InputDecoration(
                  ...
                  border: OutlineInputBorder(
                      borderRadius: BorderRadius.circular(8),
                      borderSide:
                          const BorderSide(width: 1, color: Color(0xff9E9E9E))),
          ...
          TextButton(
            onPressed: () {
              if(controller.firstNameController.text.isEmpty || controller.lastNameController.text.isEmpty || controller.phoneController.text.isEmpty){
                Get.snackbar('Error', 'All fields must be provided',colorText: Colors.white,backgroundColor: Colors.red);
                return;
              }
              Navigator.pop(context);
